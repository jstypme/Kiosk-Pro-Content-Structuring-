...
const InputSection: React.FC<InputSectionProps> = ({ onGenerate, isLoading }) => {
  ...
  return (
    <div className="bg-[#111] rounded-3xl shadow-2xl shadow-purple-900/10 border border-white/10 p-10 relative overflow-hidden group">
      ...
      <div className="mb-8 relative z-10">
        <h2 className="text-3xl font-bold text-white flex items-center gap-3 mb-3">
          <span className="w-10 h-10 bg-purple-600 text-white rounded-xl flex items-center justify-center text-lg shadow-lg shadow-purple-600/30">
      ...
      <div className="relative z-10">
        <textarea
          className="w-full h-72 p-6 rounded-2xl border border-white/10 bg-black text-slate-300 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 transition-all outline-none resize-none font-mono text-sm shadow-inner placeholder:text-slate-700"
...
Dimensions: 162.3 x 79 x 8.6mm, 232g."
      ...
      <div className="mt-8 flex justify-end relative z-10">
        <button
          ...
          className={`
            flex items-center gap-3 px-10 py-4 rounded-xl font-bold text-white shadow-lg transition-all transform active:scale-95
            ${!text.trim() || isLoading 
