...
const InputSection: React.FC<InputSectionProps> = ({ onGenerate, isLoading }) => {
  ...
  return (
    <div className="bg-black/60 backdrop-blur-xl rounded-3xl shadow-2xl shadow-black/50 border border-white/10 p-6 md:p-10 relative overflow-hidden group">
      ...
      <div className="relative z-10">
        <textarea
          className="w-full h-48 md:h-72 p-4 md:p-6 rounded-2xl border border-white/10 bg-black/50 text-slate-300 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 transition-all outline-none resize-none font-mono text-xs md:text-sm shadow-inner placeholder:text-slate-700"
